...
$messages['ba'] = array(
	'nuke' => 'Күпл�п юйыу',
	'nuke-desc' => 'Х�кимд��г� битт���е [[Special:Nuke|күпл�п юйыу]] мөмкинлеген би��',
	'nuke-nopages' => 'Һуңғы ү�г��теү����� [[Special:Contributions/$1|$1]] та�афынан булды�ылған битт�� юҡ.',
	'nuke-list' => 'Түб�нд�ге битт�� [[Special:Contributions/$1|$1]] та�афынан яңы�аҡ булды�ылған.
Ула��ы юйы� өсөн, аңлатма ке�етеге� һ�м төйм�г� баҫығы�.',
	'nuke-defaultreason' => '$1 та�афынан булды�ылған битт���е күпл�п юйыу',
	'nuke-tools' => 'Был бит билд�л�нг�н ҡатнашыусы й�ки IP ад�ес та�афынан булды�ылған битт���е күпл�п юйыу мөмкинлеген би��.
Юйыла то�ған битт�� исемлеген алы� өсөн, ҡатнашыусы исемен й�ки IP ад�есты ке�етеге�.',
	'nuke-submit-user' => 'Үт��г�',
	'nuke-submit-delete' => 'Һайланғанда��ы юйы�ға',
	'right-nuke' => 'Битт���е күпл�п юйыу',
 ...
 */
$messages['be'] = array(
	'nuke' => 'Масавае сці�анне',
	'nuke-desc' => 'Дае адмініст�ата�ам магчымасць [[Special:Nuke|масавага выдалення]] ста�онак',
	'nuke-nopages' => 'Няма новых ста�онак аўта�ства [[Special:Contributions/$1|$1]] у нядаўніх змяненнях.',
	'nuke-list' => 'Наступныя ста�онкі былі нядаўна ство�аныя [[Special:Contributions/$1|$1]];
упішыце тлумачэнне і націсніце кнопку, каб іх сце�ці.',
	'nuke-defaultreason' => 'Масавае сці�анне ста�онак, ство�аных $1',
	'nuke-tools' => 'Інст�умент дазваляе масава сці�аць ста�онкі, дададзеныя нядаўна пэўным удзельнікам ці з пэўнага IP-ад�асу.
Упішыце імя ўдзельніка ці IP, каб ат�ымаць пе�алік ста�онак, якія можна сце�ці.',
	'nuke-submit-user' => 'Напе�ад',
	'nuke-submit-delete' => 'Сце�ці пазначанае',
	'right-nuke' => 'масава сці�аць ста�онкі',
);
...
$messages['be-tarask'] = array(
	...
	'action-nuke' => 'масавае выдаленьне ста�онак',
	'nuke-desc' => 'Дае адмініст�ата�ам магчымасьць [[Special:Nuke|масавага выдаленьня]] ста�онак',
	'nuke-nopages' => 'У апошніх зьменах няма новых ста�онак, ство�аных [[Special:Contributions/$1|$1]].',
	'nuke-list' => 'Наступныя ста�онкі былі нядаўна ство�аны ўдзельнікам [[Special:Contributions/$1|$1]];
дадайце камэнта� і націсьніце кнопку для іх выдаленьня.',
	'nuke-list-multiple' => 'Наступныя ста�онкі былі ство�аны нядаўна;
устаўце камэнта� і націсьніце кнопку каб іх выдаліць.',
	'nuke-defaultreason' => 'Масавае выдаленьне ста�онак, ство�аных удзельнікам $1',
	'nuke-multiplepeople' => 'Масавае выдаленьне нядаўна дададзеных ста�онак',
	'nuke-tools' => 'Гэты інст�умэнт дазваляе �абіць масавыя выдаленьні ста�онак, ство�аных пэўным удзельнікам альбо з IP-ад�асу. Увядзіце імя ўдзельніка ці IP-ад�ас для таго, каб ат�ымаць сьпіс ста�онак для выдаленьня, ці пакіньце пустым для ўсіх удзельнікаў.',
	'nuke-submit-user' => 'Выканаць',
	'nuke-submit-delete' => 'Выдаліць выб�аныя',
	'right-nuke' => 'масавае выдаленьне ста�онак',
	'nuke-select' => 'Выб�аць: $1',
	'nuke-userorip' => 'Удзельнік, IP-ад�ас ці пустое:',
	'nuke-maxpages' => 'Максымальная колькасьць ста�онак:',
	'nuke-editby' => 'Ство�ана [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => 'Ста�онка «$1» выдаленая.',
	'nuke-not-deleted' => "Ста�онка [[:$1]] '''ня можа''' быць выдаленая.",
	'nuke-delete-more' => '[[Special:Nuke|Масавае выдаленьне ста�онак]]',
	'nuke-pattern' => 'Узо� для назвы ста�онкі:',
	'nuke-nopages-global' => 'У [[Special:RecentChanges|апошніх зьменах]] больш няма новых ста�онак.',
);
 ...
 */
$messages['bg'] = array(
	'nuke' => 'Масово изт�иване',
	'nuke-desc' => 'П�едоставя на админист�ато�ите възможност за [[Special:Nuke|масово изт�иване]] на ст�аници',
	'nuke-nopages' => 'С�ед последните п�омени не съществуват нови ст�аници, създадени от [[Special:Contributions/$1|$1]].',
	'nuke-list' => 'Следните ст�аници са били наско�о създадени от [[Special:Contributions/$1|$1]]. Напишете комента� и щ�акнете бутона, за да ги изт�иете.',
	'nuke-defaultreason' => 'Масово изт�иване на ст�аници, създадени от $1',
	'nuke-tools' => 'Този инст�умент позволява масовото изт�иване на ст�аници, създадени от даден �егист�и�ан или анонимен пот�ебител. Въведете пот�ебителско име или IP, за да получите списъка от ст�аници за изт�иване:',
	'nuke-submit-user' => 'Отва�яне',
	'nuke-submit-delete' => 'Изт�иване на изб�аните',
	'right-nuke' => 'масово изт�иване на ст�аници',
);
...
$messages['bn'] = array(
	...
	'nuke-multiplepeople' => 'একাধিক ব্যবহারকার�',
	'nuke-tools' => 'এই সরঞ্জামটি ব্যবহার করে আপনি একটি প্রদত্ত ব্যবহারকার�র বা আইপি ঠিকানার যোগ করা পাতাগুলি গণ আকারে মুছে ফেলতে পারবেন। পাতাগুলির তালিকা পেতে ব্যবহারকার� নাম বা আইপি ঠিকানাটি ইনপুট করুন:',
	'nuke-submit-user' => 'যাও',
	'nuke-submit-delete' => 'নির্বাচিত গুলো মুছে ফেলো',
	'nuke-select' => 'নির্বাচন: $1',
	'nuke-userorip' => 'ব্যবহারকার� নাম, আইপি ঠিকানা বা খালি:',
...
$messages['ce'] = array(
	'nuke' => 'Дуккха дIадайа�',
	'nuke-defaultreason' => 'Декъашхочо кхоьллина агIонаш, дуккха дIайайа� $1',
	'nuke-submit-delete' => 'Дlадайá хаь�жна�ш',
	'right-nuke' => 'дуккха агIонаш дIайайа�',
);
...
$messages['cs'] = array(
	...
	'nuke-list' => 'Následující stránky nedávno vytvo�il uživatel [[Special:Contributions/$1|$1]]; vyplňte komentá� a všechny smažte kliknutím na tlačítko.',
	'nuke-list-multiple' => 'Nedávno byly vytvo�eny následující stránky;
zadáním komentá�e a stisknutím tlačítka je smažete.',
	'nuke-defaultreason' => 'Hromadné odstranění stránek, které vytvo�il $1',
	'nuke-multiplepeople' => 'více uživatelů',
	'nuke-tools' => 'Tento nástroj umožňuje hromadné smazání stránek nedávno vytvo�ených zadaným uživatelem nebo IP adresou.
Zadejte uživatelské jméno nebo IP adresu, zobrazí se seznam stránek ke smazání; p�ípadně ponechte prázdné pro všechny uživatele.',
	...
	'nuke-editby' => '{{gender:$1|Vytvo�il|Vytvo�ila|Vytvo�il}} [[Special:Contributions/$1|$1]]',
...
$messages['el'] = array(
	...
	'nuke-nopages' => 'Καμία νέα σελίδα α�ό τον/την [[Special:Contributions/$1|$1]] στις �ρόσφατες αλλαγές.',
	'nuke-list' => 'Οι ακόλουθες σελίδες δημιουργήθηκαν �ροσφατα α�ό τον/την [[Special:Contributions/$1|$1]]·
βάλτε ένα σχόλιο και �ατήστε το κουμ�ί για να τις διαγράψετε.',
	'nuke-defaultreason' => 'Μαζική αφαίρεση σελίδων �ροστιθέμενων α�ό τον/την $1',
	'nuke-multiplepeople' => '�ολλα�λοί χρήστες',
	'nuke-tools' => 'Αυτό το εργαλείο ε�ιτρέ�ει μαζικές διαγραφές σελίδων �ρόσφατα �ροστιθέμενων α�ό έναν δοσμέ-νο/νη χρήστ-η/ρια ή IP.<br />
Εισάγετε το όνομα χρήστ-η/ριας ή την IP για να �άρετε έναν κατάλογο με σελίδες �ρος διαγραφή.',
	'nuke-submit-user' => 'Πήγαινε',
	'nuke-submit-delete' => 'Διαγραφή ε�ιλεγμένων',
	'right-nuke' => 'Μαζική διαγραφή σελίδων',
	'nuke-select' => 'Ε�ιλογή: $1',
	'nuke-userorip' => 'Όνομα χρήστη, διεύθυνση IP ή κενό:',
	'nuke-maxpages' => 'Μέγιστος αριθμός σελίδων:',
	'nuke-editby' => 'Δημιουργήθηκε α�ό [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Η σελίδα '''$1''' έχει διαγραφεί.",
	'nuke-not-deleted' => "Η σελίδα [[:$1]] '''δεν μ�ορούσε''' να διαγραφεί.",
);
...
entrez un commentaire et cliquez sur le bouton pour les supprimer.',
	...
	'nuke-tools' => 'Cet outil permet les suppressions en masse des pages ajoutées récemment par un utilisateur enregistré ou par une adresse IP. Indiquer ladresse IP afin dobtenir la liste des pages à supprimer, ou laisser blanc pour tous les utilisateurs.',
...
Buchiér lo nom dusanciér ou ben ladrèce IP por avêr la lista de les pâges a suprimar, ou ben lèssiér blanc por tôs los usanciérs.',
	...
	'nuke-userorip' => 'Nom dusanciér, adrèce IP ou ben vouedo :',
...
$messages['grc'] = array(
	...
	'nuke-nopages' => 'Οὐδεμία νέα δέλτος ὑ�ὸ τοῦ [[Special:Contributions/$1|$1]] ἐν ταῖς �ροσφάτοις �λλαγαῖς.',
	'nuke-list' => 'Αἱ �κόλουθοι δέλτοι �ροσφάτως ἐ�οιήθησαν ὑ�ὸ τοῦ/τῆς [[Special:Contributions/$1|$1]]·
ἐνα�όθου σχόλιόν τι καὶ �ίεσον τὸ κομβίον ἵνα διαγράψῃς αὗται.',
	'nuke-defaultreason' => 'Μαζικὴ �φαίρεσις δέλτων �ροστεθειμένων ὑ�ὸ τοῦ $1',
	'nuke-tools' => 'Τόδε τὸ ἐργαλεῖον ἐ�ιτρέ�ει τὰν μαζικὰν διαγραφὰς δἐλτων �ροσφάτως �ροστεθειμένων ἐξ ἑνὸς δεδομένου χρωμένου ἢ ἑνὸς IP (Διαδικτυακοῦ Πρωτοκόλλου).
Ἔξεστί σοι εἰσάξειν τὸ �νοματεῖον ἢ τὸ IP ἵνα λάβῃς μίαν καταλογὴν διαγρα�τέων δέλτων.',
	'nuke-submit-user' => 'Ἱέναι',
	'nuke-submit-delete' => 'Διαγράφειν τὴν ἐ�ειλεγμένην',
...
$messages['he'] = array(
	'nuke' => 'מח�קה מרובה',
	'action-nuke' => 'למחוק דפ�ם מרוב�ם',
	'nuke-desc' => 'אפשרות למפע�ל� המערכת לבצע [[Special:Nuke|מח�קה מרובה]] של דפ�ם',
	'nuke-nopages' => 'א�ן דפ�ם חדש�ם שנוצרו על �ד� [[Special:Contributions/$1|$1]] in בש�נו��ם האחרונ�ם.',
	'nuke-list' => 'הדפ�ם הבא�ם נוצרו לאחרונה על �ד� [[Special:Contributions/$1|$1]];
אנא כתבו נ�מוק למח�קה ולחצו על הכפתור כד� למחוק אותם.',
	'nuke-list-multiple' => 'הדפ�ם הבא�ם נוצרו לאחרונה;
אנא כתבו נ�מוק למח�קה ולחצו על הכפתור כד� למחוק אותם.',
	'nuke-defaultreason' => 'הסרה מרובה של דפ�ם שנוספו על �ד� $1',
	'nuke-multiplepeople' => 'משתמש�ם מרוב�ם',
	'nuke-tools' => 'כל� זה מאפשר מח�קות המונ�ות של דפ�ם שנוספו לאחרונה על �ד� משתמש או כתובת IP מסו�מ�ם.
כתבו את שם המשתמש או כתובת ה־IP כד� לקבל את רש�מת הדפ�ם למח�קה או השא�רו את השדה הזה ר�ק עבור כל המשתמש�ם.',
	'nuke-submit-user' => 'הצגה',
	'nuke-submit-delete' => 'מח�קת הדפ�ם שנבחרו',
	'right-nuke' => 'מח�קה מרובה של דפ�ם',
	'nuke-select' => 'בח�רה: $1',
	'nuke-userorip' => 'שם משתמש, כתובת IP או ר�ק:',
	'nuke-maxpages' => 'מספר מרב� של דפ�ם:',
	'nuke-editby' => 'נוצר על �ד� [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "הדף '''$1''' נמחק.",
	'nuke-not-deleted' => "'''לא נ�תן''' למחוק את הדף [[:$1]].",
	'nuke-delete-more' => '[[Special:Nuke|למחוק עוד דפ�ם]]',
	'nuke-pattern' => 'תבנ�ת עבור שם הדף:',
	'nuke-nopages-global' => 'א�ן דפ�ם חדש�ם ב[[Special:RecentChanges|ש�נו��ם אחרונ�ם]].',
);
...
$messages['hi'] = array(
	...
	'nuke-desc' => 'प्रबंधकोंको एकसाथ [[Special:Nuke|बहुत सारे पन्ने हटानेक�]] अनुमति देता हैं',
	'nuke-nopages' => 'हाल में हुए बदलावोंमें [[Special:Contributions/$1|$1]] द्वारा नये पन्ने नह�ं हैं।',
	'nuke-list' => 'न�चे दिये हुए पन्ने [[Special:Contributions/$1|$1]] ने हाल में बनायें हैं; टिप्पण� दें और हटाने के लिये बटनपर क्लिक करें।',
	'nuke-defaultreason' => '$1 ने बनाये हुए पन्ने एकसाथ हटायें',
	'nuke-tools' => 'यह उपकरण किस� सदस्य या IP द्वारा हाल ह� में जोड़े गए पृष्ठों को सामूहिक रूप से हटाने में सहायक है।
सदस्यनाम या IP डालकर हटाने वाले पृष्ठों क� सूच� प्राप्त करें।',
	'nuke-submit-user' => 'जायें',
	'nuke-submit-delete' => 'चुने हुए हटायें',
	'right-nuke' => 'बहुतसे पन्ने एकसाथ हटायें',
	'nuke-select' => 'चयन करें: $1',
	'nuke-userorip' => 'सदस्यनाम, आईप� पते या खाल�:',
...
$messages['hsb'] = array(
	...
	'nuke-list' => 'Slědowace strony buchu runje p�ez [[Special:Contributions/$1|$1]] wutworjene; zapodaj komentar a klikń na tłóčatko wušmórnjenja.',
...
napisaj komentar a klikń na tłóčatko, zo by je wušmórnył.',
	...
	'nuke-multiplepeople' => 'Masowe zhašenje njedawno p�idatych stronow',
	'nuke-tools' => 'Tutón grat zmóžnja masowe wušmórnjenje stronow, kotrež buchu wot IP-adresy abo wužiwarja p�idate. Zapodaj IP-adresu abo wužiwarske mjeno, zo by lisćinu stronow dóstał, kotrež maja so wušmórnyć.',
	...
	'nuke-pattern' => 'P�ikład za mjeno strony:',
...
$messages['ja'] = array(
	'nuke' => '�括削�',
	'nuke-desc' => '{{int:group-sysop}}がページを[[Special:Nuke|�括削�]]できる機能を提供しま��',
	'nuke-nopages' => '�近の更新ページに[[Special:Contributions/$1|$1]]が新規作成したページはありません�',
	'nuke-list' => '以下は�[[Special:Contributions/$1|$1]] によって�近作成されたページの�覧で�；
理由を記入しボタンを押�と�これらは削�されま��',
	'nuke-list-multiple' => '�近作成されたページが表示されていま��
コメントを入力し�ボタンを押�と�削�されま��',
	'nuke-defaultreason' => '$1 によって加えられたページを�括削�',
	'nuke-multiplepeople' => '複数の利用�',
	'nuke-tools' => 'このツールを使うと�指定した利用�またはIPアドレスによって�近作成されたページを�まとめて削��ることができま��
利用�名またはIPアドレスを入力�ると�削�対象ページの�覧が生成されま��空に�ると��べての利用�によるものが対象になりま��',
	'nuke-submit-user' => '�覧取得',
	'nuke-submit-delete' => '選択されたページを削�',
	'right-nuke' => 'ページの�括削�',
	'nuke-select' => '選択：$1',
	'nuke-userorip' => '利用�名�IP アドレスまたは空�:',
	'nuke-maxpages' => 'ページの�大量:',
	'nuke-editby' => '[[Special:Contributions/$1|$1]]によって作成',
	'nuke-deleted' => "ページ  '''$1''' は削�されていま��",
	'nuke-not-deleted' => "Page [[:$1]] は削�'''出来ません''' �",
);
...
შეიყვანეთ �ომენტარი და დააჭირეთ ღილა�ს მათ წასაშლელად.',
...
$messages['km'] = array(
	'nuke' => 'លុបចេញ�ជាខ្សែ',
	'nuke-desc' => 'ផ្តល់លទ្ធភាព�ឱ្ឋអ្ន�ថែទាំប្រព័ន្ធ [[Special:Nuke|លុបចេញ�ជាខ្សែ]] ទំព័រនានា',
	'nuke-nopages' => 'គ្មាន�ទំព័រ�ថ្មី [[Special:Contributions/$1|$1]] �្នុង�បំលាស់ប្តូរ�ថ្មីៗ�។',
	'nuke-list' => 'ទំព័រទាំងនេះ ទើបតែ�ត្រូវ�បាន�បង្�ើត ដោ� [[Special:Contributions/$1|$1]]; សូម�ដា�់�ហេតុផល និង�ចុច�ប្រអប់�ដើម្បី�លុបចេញ�ពួ�វា�។',
	'nuke-defaultreason' => '�ារដ�ចេញ�ជាខ្សែ នៃ�ទំព័រ�បានបន្ថែម�ដោ� $1',
	'nuke-tools' => 'ឧប�រណ៍�នេះ អនុញ្ញាត�លុបចេញ�ជាខ្សែ�នូវ�ទំព័រ�ទើប�បាន�បន្ថែម�ថ្មីៗ ដោឋអ្ន�ប្រើប្រាស់�បាន�ចុះ�ឈ្មោះ ឬ ដោឋអាស�ដ្ឋាន IP ។ សូម�បញ្ចូល�អត្តនាមអ្ន�ប្រើប្រាស់ ឬ អាស�ដ្ឋាន IP ដើម្បី�មាន�បញ្ជីទំព័រ�សម្រាប់�លុប�៖',
	'nuke-submit-user' => 'ទៅ',
	'nuke-submit-delete' => 'លុបចេញ ជម្រើស��',
);
...
$messages['ko'] = array(
	'nuke' => '문서 �량 삭제',
	'action-nuke' => '문서를 �량 삭제할',
	'nuke-desc' => '�리자� 문서를 [[Special:Nuke|�량 삭제]]할 수 있는 기능을 추�합니다.',
	'nuke-nopages' => '최근에 [[Special:Contributions/$1|$1]] 사용자� 만든 문서� 없습니다.',
	'nuke-list' => '다음� [[Special:Contributions/$1|$1]]이(�) 최근에 만든 문서입니다.
삭제에 �한 이유를 입력한 다음 아래 버튼을 클릭해주세요.',
	'nuke-list-multiple' => '다음� 최근에 생성된 문서입니다.
문서를 삭제하려면 이유를 입력하고 삭제 버튼을 누르십시오.',
	'nuke-defaultreason' => '$1이(�) 작성한 문서를 �량 삭제함',
	'nuke-multiplepeople' => '최근 작성된 문서를 �량 삭제함',
	'nuke-tools' => '이 도구를 이용해 특정 사용자나 IP 사용자� 최근 생성한 문서를 �량으로 삭제할 수 있습니다.
삭제할 문서 목록을 �져오려면 계정 이름이나 IP 주소를 입력하십시오. 입력하� 않으면 모든 사용자를 �상으로 합니다.',
	'nuke-submit-user' => '계속',
	'nuke-submit-delete' => '선택한 문서 삭제',
	'right-nuke' => '문서 �량 삭제',
	'nuke-select' => '선택: $1',
	'nuke-userorip' => '계정 이름이나 IP 주소 (혹� 공�으로 남겨 두십시오):',
	'nuke-maxpages' => '문서의 최� 크기:',
	'nuke-editby' => '[[Special:Contributions/$1|$1]]이(�) 생성함',
	'nuke-deleted' => "문서 '''$1'''이(�) 삭제되었습니다.",
	'nuke-not-deleted' => "문서 [[:$1]]를 삭제하� '''못했습니다'''.",
	'nuke-delete-more' => '[[Special:Nuke|더 많� 문서를 삭제하기]]',
	'nuke-pattern' => '문서 이름의 패턴:',
	'nuke-nopages-global' => '[[Special:RecentChanges|최근 바�]]에 새 문서� 없습니다.',
);
...
$messages['lt'] = array(
	...
	'nuke-desc' => 'Suteikia administratoriams galimyb� [[Special:Nuke|masiškai trinti]] puslapius',
...
$messages['lzh'] = array(
	...
	'nuke-list' => '[[Special:Contributions/$1|$1]]之作�示；剔註再點刪之�',
	'nuke-defaultreason' => '量刪由$1�建之頁',
	'nuke-tools' => '此意供簿或IP建之頁�入簿名加�取表作刪也：',
	'nuke-submit-user' => '�',
...
$messages['mk'] = array(
	'nuke' => 'Г�упно б�ишење',
	'action-nuke' => 'масовно б�ишење на ст�аници',
	'nuke-desc' => 'Им дава можност на админист�ато�ите да в�шат [[Special:Nuke|г�упно б�ишење]] на ст�аници',
	'nuke-nopages' => 'Нема нови ст�аници од [[Special:Contributions/$1|$1]] во ско�ешните п�омени.',
	'nuke-list' => 'Следниве ст�аници биле неодамна создадени од [[Special:Contributions/$1|$1]];
вметнете комента� и п�итиснете на копчето за да ги изб�ишете',
	'nuke-list-multiple' => 'Следниве ст�аници се создадени неодамна.
Внесете комента� и стиснете на копчето за да ги изб�ишете.',
	'nuke-defaultreason' => 'Г�упно отст�анување на ст�аници додадени од $1',
	'nuke-multiplepeople' => 'Г�упно б�ишење на неодамна додадени ст�аници',
	'nuke-tools' => 'Оваа алатка овозможува зби�ни б�ишења на ст�аници неодамна додадени од извесен ко�исник или IP-ад�еса.
Внесете го ко�исничкото име или IP-ад�еса за да го добиете списокот на ст�аници за б�ишење, или пак оставете го п�азно ако сакате да се наведат сите ко�исници.',
	'nuke-submit-user' => 'Изв�ши',
	'nuke-submit-delete' => 'Изб�иши ги изб�аните',
	'right-nuke' => 'Г�упно б�ишење на ст�аници',
	'nuke-select' => 'Одбе�и: $1',
	'nuke-userorip' => 'Ко�исничко име, IP-ад�еса или п�азно:',
	'nuke-maxpages' => 'Макс. б�ој на ст�аници:',
	'nuke-editby' => 'Создадено од [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Ст�аницата '''$1''' е изб�ишана.",
	'nuke-not-deleted' => "Ст�аницата [[:$1]] '''не можеше''' да се изб�ише.",
	'nuke-delete-more' => '[[Special:Nuke|Изб�иши уште ст�аници]]',
	'nuke-pattern' => 'Мост�а за име на ст�аница:',
	'nuke-nopages-global' => 'Нема нови ст�аници во [[Special:RecentChanges|ско�ешните п�омени]].',
);
...
$messages['ml'] = array(
	...
	'nuke-nopages' => '[[Special:Contributions/$1|$1]] ഉണ്ടാക്കിയ പുതിയ താളുകളൊന്നും പുതിയ മാറ്റ�്�ളിലില്ല.',
	'nuke-list' => 'താഴെ പ്രദർശിപ്പിച്ചിരിക്കുന്ന താളുകൾ [[Special:Contributions/$1|$1]] സമ�പ കാലത്ത് സൃഷ്ടിച്ചവ ആണ്�;
...
അഭിപ്രായമാക്കിയിട്ട് അവ മായ്ക്കാനായി ബട്ടൺ ഞെക്കുക.',
	...
	'nuke-multiplepeople' => 'സമ�പകാലത്ത് ചേർത്ത താളുകളുടെ കൂട്ട മായ്ക്കൽ',
	'nuke-tools' => 'ഏതെ�്കിലും ഒരു ഉപയോക്താവ് അല്ലെ�്കിൽ ഐ.പി. സമ�പകാലത്തു സൃഷ്ടിച്ച താളുകൾ കൂട്ടമായി മായ്ക്കാനുള്ള സൗകര്യം ഈ സം�വിധാനം നൽകുന്നു. ഉപയോക്തൃനാമം അല്ലെ�്കിൽ ഐ.പി. ഇവിടെ നൽകിയാൽ മായ്ക്കേണ്ട താളുകളുടെ പട്ടിക ലഭ്യമാകുന്നതാണ്, എല്ലാ ഉപയോക്താക്കളും സൃഷ്ടിച്ചിട്ടുള്ള താൾ മായ്ക്കാൻ ശൂന്യമായിടുക.',
	...
	'nuke-userorip' => 'ഉപയോക്തൃനാമം, ഐ.പി. വിലാസം അല്ലെ�്കിൽ ശൂന്യമായിടുക:',
	...
	'nuke-nopages-global' => '[[Special:RecentChanges|സമ�പകാലമാറ്റ�്�ളിൽ]] പുതിയ താളുകളൊന്നുമില്ല.',
);
...
$messages['mr'] = array(
	...
	'nuke-desc' => 'प्रबंधकांना एकाचवेळ� [[Special:Nuke|अनेक पाने वगळण्याच�]] परवानग� देते',
	'nuke-nopages' => '[[Special:Contributions/$1|$1]] कडून अल�कड�ल बदलांमध्ये नव�न पाने नाह�त.',
	'nuke-list' => 'खाल�ल पाने ह� [[Special:Contributions/$1|$1]] ने अलिकडे वाढविलेल� आहेत; शेरा द्या व वगळण्यासाठ� कळ�वर टिचक� द्या.',
	'nuke-defaultreason' => '$1 ने नव�न वाढविलेल� अनेक पाने एकावेळ� वगळा',
	'nuke-tools' => 'हे उपकरण एखाद्या विशिष्ट सदस्य अथवा अंकपत्त्याद्वारे नव�न तयार करण्यात आलेल्या पानांना एकाचवेळ� वगळण्याच� संध� देते. सदस्य नाव अथवा अंकपत्ता दिल्यास वगळण्यासाठ� पानांच� याद� मिळेल:',
	'nuke-submit-user' => 'जा',
...
$messages['nds'] = array(
	...
	'nuke-nopages' => 'Gifft in de Neesten Ännern kene neen Sieden vun [[Special:Contributions/$1|$1]].',
...
$messages['ne'] = array(
	...
	'nuke-userorip' => 'प्रयोगकर्ता, आइप� ठेगाना वा खाल�:',
...
$messages['oc'] = array(
	...
	'nuke-tools' => 'Aquesta aisina autoriza las supressions en massa de las paginas apondudas recentament per un utilizaire enregistrat o per una adreça IP. Indicatz ladreça IP per obténer la tièra de las paginas de suprimir :',
	'nuke-submit-user' => 'Validar',
...
$messages['or'] = array(
	...
	'nuke-userorip' => 'ବ୍ୟବହାରକାର� ନାମ, ଆଇପି ଠିକଣା କିମ୍ବା ଖାଲି :',
	'nuke-maxpages' => 'ଅତ୍ୟଧିକ ସଂଖ୍ୟକ ପୃଷ୍ଠା :',
	'nuke-editby' => '[[Special:Contributions/$1|$1]]�୍କ ଦ୍ଵାରା ତିଆରିକରାଯାଇଛି',
	'nuke-deleted' => "'''$1'''ପୃଷ୍ଠାଟିକୁ ଲିଭାଇ ଦିଆଗଲା ।",
	'nuke-pattern' => 'ପୃଷ୍ଠା ନାମ ପାଇଁ ଶୈଳ�:',
 ...
 */
$messages['os'] = array(
	'nuke' => 'Би�æгай аппа�ын',
	'nuke-submit-user' => 'Афтæ уæд',
	'right-nuke' => 'фæ�стæ би�æгай аппа�ын',
);
...
$messages['pl'] = array(
	...
	'nuke-desc' => 'Dodaje administratorom funkcj� równoczesnego [[Special:Nuke|usuwania dużej liczby stron]]',
	'nuke-nopages' => 'Brak nowych stron autorstwa [[Special:Contributions/$1|$1]] w ostatnich zmianach.',
	'nuke-list' => 'Nast�pujące strony zostały ostatnio utworzone przez [[Special:Contributions/$1|$1]]; wpisz komentarz i wciśnij przycisk by usunąć je.',
	'nuke-list-multiple' => 'Poniższa lista przedstawia ostatnio dodane strony.
Wpisz powód, a nast�pnie zatwierdź usuni�cie stron.',
	'nuke-defaultreason' => 'Masowe usuni�cie stron dodanych przez $1',
	'nuke-multiplepeople' => 'Masowe usuwanie ostatnio dodanych stron',
	'nuke-tools' => 'Narz�dzie pozwala na masowe usuwanie stron ostatnio dodanych przez zarejestrowanego lub anonimowego użytkownika.
Wpisz nazw� użytkownika lub adres IP by otrzymać list� stron do usuni�cia. Możesz także nic nie wpisywać, wtedy b�dzie można masowo usunąć wkład wszystkich użytkowników.',
	'nuke-submit-user' => 'Dalej',
	'nuke-submit-delete' => 'Usuń zaznaczone',
	'right-nuke' => 'Masowe usuwanie stron',
	'nuke-select' => 'Wybierz: $1',
	'nuke-userorip' => 'Podaj nazw� użytkownika, adres IP lub pozostaw puste pole',
	'nuke-maxpages' => 'Maksymalna liczba stron',
	'nuke-editby' => 'Utworzona przez [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Strona '''$1''' została usuni�ta.",
	'nuke-not-deleted' => "Strony [[:$1]] '''nie można''' usunąć.",
	'nuke-delete-more' => '[[Special:Nuke|Usuń wi�cej stron]]',
...
$messages['ro'] = array(
	...
	'nuke-desc' => 'Oferă administratorilor abilitatea de [[Special:Nuke|a �terge în masă]] pagini',
...
adăugați un comentariu �i apăsați butonul pentru a le �terge.',
	...
	'nuke-tools' => 'Această unealtă permite �tergeri în masă a paginilor recent adăugate de către un utilizator dat sau adresă IP.
Introduceți numele de utilizator sau adresa IP pentru a primi o listă cu paginile de �ters sau nu completați nimic pentru a lua în calcul toți utilizatorii.',
	'nuke-submit-user' => 'Du-te',
	'nuke-submit-delete' => 'Șterge ce e marcat',
	'right-nuke' => '�terge pagini în masă',
	...
	'nuke-deleted' => "Pagina '''$1''' a fost �tearsă.",
	'nuke-not-deleted' => "Pagina [[:$1]] '''nu a putut''' fi �tearsă.",
);
...
$messages['ru'] = array(
	...
	'action-nuke' => 'массовое удаление ст�аниц',
	'nuke-desc' => 'Даёт админист�ато�ам возможность [[Special:Nuke|множественного удаления]] ст�аниц',
	'nuke-nopages' => 'Созданий ст�аниц участником [[Special:Contributions/$1|$1]] не найдено в свежих п�авках.',
	'nuke-list' => 'Следующие ст�аницы были недавно созданы участником [[Special:Contributions/$1|$1]]. Введите коммента�ий и нажмите на кнопку для того, чтобы удалить их.',
	'nuke-list-multiple' => 'Следующие ст�аницы были недавно созданы.
Оставьте п�имечание и нажмите кнопку, чтобы удалить их.',
	'nuke-defaultreason' => 'Множественное удаление ст�аниц, созданных участником $1',
	'nuke-multiplepeople' => 'Массовое удаление недавно добавленных ст�аниц',
	'nuke-tools' => 'Эта ст�аница позволяет множественно удалять ст�аницы, недавно созданные оп�еделённым участником или с заданного IP-ад�еса.
Введите имя участника или IP-ад�ес, чтобы получить список ст�аниц для удаления, или оставьте поле пустым, если хотите выб�ать всех участников.',
	'nuke-submit-user' => 'Выполнить',
	'nuke-submit-delete' => 'Удалить выб�анные',
	'right-nuke' => 'множественное удаление ст�аниц',
	'nuke-select' => 'Выбо�: $1',
	'nuke-userorip' => 'Имя участника, IP-ад�ес (можно оставить пустым):',
	'nuke-maxpages' => 'Максимальное количество ст�аниц:',
	'nuke-editby' => 'Созданные [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Ст�аница '''$1''' была удалена.",
	'nuke-not-deleted' => "Ст�аницы  [[:$1]] '''не может''' быть удалена.",
	'nuke-delete-more' => '[[Special:Nuke|Множественное удаление ст�аниц]]',
	'nuke-pattern' => 'Шаблон для имени ст�аницы:',
	'nuke-nopages-global' => 'В [[Special:RecentChanges|недавних изменениях]] нет новых ст�аниц.',
);
...
$messages['rue'] = array(
	...
	'nuke-desc' => 'Дасть адмініст�ато�ам [[Special:Nuke|масового змазаня]] сто�інок',
	'nuke-nopages' => 'В остатнїх змінах не суть жадны новы сто�інкы од хоснователя [[Special:Contributions/$1|$1]].',
	'nuke-list' => 'Наступны сто�інкы недавно ство�ив хоснователь [[Special:Contributions/$1|$1]]; выповньте комента�ь і вшыткы змажте кликнутём на клапку.',
	'nuke-list-multiple' => 'Недавно были ство�ены наступны сто�інкы;
уведжінём комента�я і стиснутём клапкы їх вымажете.',
	'nuke-defaultreason' => 'Масове вылучіня сто�інок, кот�ы ство�ив $1',
	'nuke-multiplepeople' => 'дакілько хоснователїв',
	'nuke-tools' => 'Тот іншт�умент доволює масове вылучіня сто�інок недавно ство�еных уведженым хоснователём або IP ад�есов.
Уведьте імя хоснователя або IP ад�есу, зоб�азить ся список сто�інок п�о змазаня; п�ипадно зохабте по�ожнє п�о вшыткых хоснователїв.',
	'nuke-submit-user' => 'Выконати',
	'nuke-submit-delete' => 'Змазати выбда�ны',
	'right-nuke' => 'Масове вылучіня сто�інок',
	'nuke-select' => 'Выб�ати: $1',
	'nuke-userorip' => 'Імя хоснователя, IP ад�еса або зохабте по�ожнє:',
	'nuke-maxpages' => 'Максімалне чісло сто�інок:',
	'nuke-editby' => '{{gender:$1|Ство�ивl|Ство�ила|Ство�ив}} [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Сто�інка '''$1''' была змазана.",
	'nuke-not-deleted' => "Сто�інка [[:$1]] '''не може''' быти змазана.",
);
...
$messages['sah'] = array(
	...
	'nuke-desc' => 'Админист�аата�да�га [[Special:Nuke|элбэх си�эйи бии� дьайыыннан сото�]] кыаҕы биэ�э�',
	'nuke-nopages' => 'Кэнники көннө�үүлэ� испииһэктэ�игэ� [[Special:Contributions/$1|$1]] саҥа си�эйи оҥо�бута көстүбэтэ.',
	'nuke-list' => 'Бу си�эйдэ�и сото�утааҕыта [[Special:Contributions/$1|$1]] кыттааччы оҥо�бут. Сотуоххун баҕа�а� буоллаххына быһаа�ыыны оҥо�он ба�ан тимэҕи баттаа.',
	'nuke-list-multiple' => 'Бу си�эйдэ� сото�утааҕыта оҥоһуллубутта�.
Сото�го быһаа�ыыта су�уйан ба�ан тимэҕи баттаа.',
	'nuke-defaultreason' => '$1 кыттааччы айбыт си�эйдэ�ин бүтүннүү суох оҥо�уу',
	'nuke-multiplepeople' => 'элбэх кыттааччы',
	'nuke-tools' => 'Бу си�эй көмөтүнэн ханнык эмэ кыттааччы оҥо�бут көннө�үүлэ�ин эбэтэ� бии� IP-ттан оҥоһуллубут көннө�үүлэ�и бүтүннүү суох гынахха сөп. 
Кыттааччы аатын эбэтэ� IP-тын киллэ�дэххинэ оҥо�бут көннө�үүлэ�ин тиһигэ тахсыа, ку�аанах хаалла�даххына ба�ы кыттааччыла� көннө�үүлэ�э көстүө.',
	'nuke-submit-user' => 'Толо�',
	'nuke-submit-delete' => 'Талыллыбыты сот',
	'right-nuke' => 'Си�эйдэ�и халҕаһалыы суох оҥо�уу',
	'nuke-select' => 'Талыы: $1',
	'nuke-userorip' => 'Кыттааччы аата, IP-аады�ыһа (ку�аанах хаалла�ыахха сөп):',
	'nuke-maxpages' => 'Си�эй ахсаанын хааччаҕа (максимум):',
	'nuke-editby' => 'Оҥоһуллубутта� [[Special:Contributions/$1|$1]]',
);
...
$messages['si'] = array(
	...
	'nuke-desc' => 'පිටු�ල [[Special:Nuke|සමස්ත මැකීම]] සඳහා පරිපාලක�රුන්ට අ�ස්ථා� ද�න්න',
	'nuke-defaultreason' => '$1 �ිසින් සමස්ත මැකුම් සඳහා පිටු එක් කරන ලදී',
	...
	'nuke-editby' => '[[Special:Contributions/$1|$1]] �ිසින් තනන ලදී',
	'nuke-deleted' => "'''$1''' පිටු� මකා දමන ලදි.",
	'nuke-not-deleted' => "[[:$1]] පිටු� මැකිය '''නොහැක'''.",
	'nuke-delete-more' => '[[Special:Nuke|ත�ත් පිටු මකන්න]]',
	'nuke-pattern' => 'පිටු�ේ නම සඳහා රටා�:',
	'nuke-nopages-global' => '[[Special:RecentChanges|මෑත ��නස්�ීම්�ල]]  න� පිටු නොමැත.',
);
...
$messages['sr-ec'] = array(
	'nuke' => 'Масовно б�исање',
	'action-nuke' => 'масовно б�исање ст�аница',
	'nuke-desc' => 'Даје админист�ато�у могућност да [[Special:Nuke|масовно б�ише]] ст�анице.',
	'nuke-nopages' => 'Нема нових ст�аница од ст�ане ко�исника [[Special:Contributions/$1|$1]] у ско�ашњим изменама.',
	'nuke-list' => 'Следеће ст�анице је ско�о нап�авио ко�исник [[Special:Contributions/$1|$1]]; комента�иши и п�итисни дугме за њихово б�исање.',
	'nuke-defaultreason' => 'Масовно б�исање ст�аница које је нап�авио ко�исник $1',
	'nuke-tools' => 'Ова алатка омогућава зби�но б�исање ст�аница које је недавно додао од�еђени ко�исник (са налогом или без њега).
Унесите ко�исничко име или ИП ад�есу да бисте добили списак ст�аница за б�исање, или оставите п�азно ако желите да се наведу сви ко�исници.',
	'nuke-submit-user' => 'Иди',
	'nuke-submit-delete' => 'Об�иши изаб�ано',
	'right-nuke' => 'масовно б�исање ст�аница',
);
...
$messages['te'] = array(
	...
	'nuke-desc' => 'నిర్వాహకులకు పేజ�లను [[Special:Nuke|సామూహికంగా తొలగించే]] సౌలభ్యాన్నిస్తుంది',
	'nuke-nopages' => 'ఇట�వలి మార్పులలో [[Special:Contributions/$1|$1]] సృష్టించిన కొత్త పేజ�లేమ� లేవు.',
	'nuke-list' => 'ఈ క్రింద పేర్కొన్న పేజ�లను [[Special:Contributions/$1|$1]] ఇట�వలే సృష్టించారు; వాటిని తొలగించడానికి ఎందుకో ఓ వ్యాఖ్య రాసి ఆతర్వాత తొలగించు అన్న బొత్తం నొక్కండి.',
	'nuke-defaultreason' => '$1 చేర్చిన పేజ�ల యొక్క సామూహిక తొలగింపు',
	'nuke-multiplepeople' => 'ఇట�వల సృష్టించిన పేజ�ల యొక్క సామూహిక తొలగింపు',
	'nuke-tools' => 'ఓ ప్రత్యేక వాడుకరి లేదా IP చేర్చిన పేజ�లను ఒక్కసారిగా తొలగించడానికి ఈ పనిముట్టు వ�లుకల్పిస్తుంది. పేజ�ల జాబితాని పొందడానికి ఆ వాడుకరిపేరుని లేదా IPని ఇవ్వండి:',
	'nuke-submit-user' => 'వెళ్ళు',
	'nuke-submit-delete' => 'ఎంచుకున్నవి తొలగించు',
	'right-nuke' => 'పేజ�లను సామూహికంగా తొలగించడం',
...
$messages['tg-cyrl'] = array(
	...
	'nuke-desc' => 'Ба  муди�он имкони [[Special:Nuke|ҳазфи дастаҷамъии]] саҳифаҳо�о медиҳад',
	'nuke-nopages' => 'Саҳифаи ҷадиде аз [[Special:Contributions/$1|$1]] да� тағйи�оти охи�ин вуҷуд надо�ад.',
	'nuke-list' => 'Саҳифаҳои зе�ин ба тозагӣ тавассути [[Special:Contributions/$1|$1]] эҷод шудаанд; тавзеҳе�о гузо�ед ва тугмае�о фишо� бидиҳед то ин саҳифаҳо ҳазф шаванд.',
	'nuke-defaultreason' => 'Ҳазфи дастиҷамъии саҳифаҳое, ки тавассути $1 эҷод шудаанд',
	'nuke-tools' => 'Ин абзо� имкони ҳазфи дастиҷамъии саҳифаҳое, ки ба тозагӣ тавассути як ко�ба� ё  нишонии инте�нетӣ IP изофашуда�о фа�оҳам мекунад. Номи ко�ба� ё нишонии IP ву�уд кунед, феҳ�исти саҳифаҳои ба�ои ҳазф�о даст�ас кунед:',
	'nuke-submit-user' => 'Би�ав',
...
/** Tatar (Cyrillic script) (Тата�ча)
 * @author Ильна�
 */
$messages['tt-cyrl'] = array(
	'nuke' => 'Күпл�п бете�ү',
	'right-nuke' => 'битл��не күпл�п бете�ү',
);
...
$messages['uk'] = array(
	...
	'nuke-desc' => 'Дає адмініст�ато�ам можливість [[Special:Nuke|масового вилучення]] сто�інок',
	'nuke-nopages' => 'У нових �едагуваннях не знайдено сто�інок, ство�ених ко�истувачем [[Special:Contributions/$1|$1]].',
	'nuke-list' => 'Наступні сто�інки були нещодавно ство�ені ко�истувачем [[Special:Contributions/$1|$1]].
Уведіть комента� і натисніть на кнопку для того, щоб вилучити їх.',
	'nuke-list-multiple' => 'Ці сто�інки були нещодавно ство�ені.
Залиште п�имітку й натисніть кнопку, щоб вилучити.',
	'nuke-defaultreason' => 'Масове вилучення сто�інок, ство�ених ко�истувачем $1',
	'nuke-multiplepeople' => 'Масове вилучення недавно доданих сто�інок',
	'nuke-tools' => "Цей інст�умент дозволяє масово вилучати сто�інки, ство�ені певним ко�истувачем або з певної IP-ад�еси.
Уведіть ім'я ко�истувача або IP-ад�есу для того, щоб от�имати список сто�інок для вилучення, або залиште поле по�ожнім для вибо�у усіх ко�истувачів.",
	'nuke-submit-user' => 'Виконати',
	'nuke-submit-delete' => 'Вилучити об�ані',
	'right-nuke' => 'Масове вилучення сто�інок',
	'nuke-select' => 'Вибі�: $1',
	'nuke-userorip' => "Ім'я ко�истувача, IP-ад�еса (за бажанням):",
	'nuke-maxpages' => 'Максимальна кількість сто�інок:',
	'nuke-editby' => 'Ство�ені [[Special:Contributions/$1|$1]]',
	'nuke-deleted' => "Сто�інка '''$1''' була вилучена.",
	'nuke-not-deleted' => "Сто�інка [[:$1]] '''не може''' бути вилучена.",
);
...
Đưa vào lý do và bấm nút để xóa chúng.',
	...
	'nuke-tools' => 'Công cụ này cho phép xóa hàng loạt các trang do m�t thành viên hoặc người dùng địa chỉ IP nào đó tạo ra gần đây.
 ...
 */
$messages['yi'] = array(
	'nuke-submit-user' => 'צ��גן',
	'nuke-select' => 'או�סוו��לן: $1',
);
...
$messages['yue'] = array(
	'nuke' => '大量刪�',
	'nuke-desc' => '�操作員去做[[Special:Nuke|大量刪�]]嘅能力',
	'nuke-nopages' => '響�近更改度無[[Special:Contributions/$1|$1]]�做嘅新頁�',
	'nuke-list' => '下面嘅頁係由[[Special:Contributions/$1|$1]]響之前�寫嘅；記低��註解再撳掣去刪�佢哋�',
	'nuke-defaultreason' => '大量刪�由$1�開嘅頁',
	'nuke-tools' => '呢�工具容許之前提供咗嘅用戶或�IP加入嘅頁�輸入用戶名或�IP去拎頁�覽去刪�:',
	'nuke-submit-user' => '去',
	'nuke-submit-delete' => '刪�㨂咗嘅',
	'right-nuke' => '大量刪頁',
);
...
$messages['zh-hans'] = array(
	'nuke' => '大量删�',
	'action-nuke' => '大量删�页面',
	'nuke-desc' => '让管理员可以[[Special:Nuke|大量删�]]页面',
	'nuke-nopages' => '在�近更改中没有[[Special:Contributions/$1|$1]]创建的新页面�',
	'nuke-list' => '以下为[[Special:Contributions/$1|$1]]�近创建的页面，请填�注释并点击按钮删�它们�',
	'nuke-list-multiple' => '以下为�近创建的页面，请填�注释并点击按钮删�它们�',
	'nuke-defaultreason' => '大量删�$1创建的页面',
	'nuke-multiplepeople' => '大量删��近添加的页面',
	'nuke-tools' => '此工具允许大量删�指定用户或IP地�在�近创建的页面�输入用户名或IP地�可获取可删�页面列表，����索�有用户�',
	'nuke-submit-user' => '执行',
	'nuke-submit-delete' => '删���',
	'right-nuke' => '大量删�页面',
	'nuke-select' => '�择：$1',
	'nuke-userorip' => '用户名�IP地�或空�：',
	'nuke-maxpages' => '�多页面数：',
	'nuke-editby' => '由[[Special:Contributions/$1|$1]]创建',
	'nuke-deleted' => "已删�页面'''$1'''�",
	'nuke-not-deleted' => "'''无法'''删�[[:$1]]页面�",
	'nuke-delete-more' => '[[Special:Nuke|删�更多页面]]',
	'nuke-pattern' => '页面名称的模式：',
	'nuke-nopages-global' => '[[Special:RecentChanges|�近更改]]中没有新的页面�',
);
...
$messages['zh-hant'] = array(
	'nuke' => '大量刪�',
	'action-nuke' => '大量刪�頁面',
	'nuke-desc' => '給操作員作出[[Special:Nuke|大量刪�]]的能力',
	'nuke-nopages' => '在�近更改中沒有 [[Special:Contributions/$1|$1]] �作的新頁面�',
	'nuke-list' => '以下的頁面是由[[Special:Contributions/$1|$1]]在以前�寫的；記下��註解再點擊按鈕去刪�它��',
	'nuke-list-multiple' => '以下為�近創建的頁面，請填寫註釋並點擊按鈕刪�它��',
	'nuke-defaultreason' => '大量刪�由 $1 �建立的頁面',
	'nuke-multiplepeople' => '大量刪��近添加的頁面',
	'nuke-tools' => '此工具允許大量刪�指定用戶或IP地�在�近創建的頁面�輸入用戶名或IP地�可獲取可刪�頁面列表，��則檢索�有用戶�',
	'nuke-submit-user' => '執行',
	'nuke-submit-delete' => '刪�已選擇的',
	'right-nuke' => '大量刪�頁面',
	'nuke-select' => '選擇：$1',
	'nuke-userorip' => '用戶名�IP地�或空�：',
	'nuke-maxpages' => '�多頁面數：',
	'nuke-editby' => '由[[Special:Contributions/$1|$1]]創建',
	'nuke-deleted' => "'''$1'''頁面已刪��",
	'nuke-not-deleted' => "'''無法'''刪�[[:$1]]頁面�",
	'nuke-delete-more' => '[[Special:Nuke|刪�更多頁面]]',
	'nuke-pattern' => '頁面名稱的模式：',
	'nuke-nopages-global' => '[[Special:RecentChanges|�近更改]]中沒有新的頁面�',
);
